...
func configLoadFile() {
	...
	if err != nil {
		log.Println("{\"label\":\"config-load-file\",\"level\":\"warning\",\"msg\":\"error loading config file, " + err.Error() + "\",\"service\":\"" + Config.GetString("SERVER_NAME") + "\",\"time\":" + fmt.Sprint(utils.TimeNowVietNam()) + "\"}")
	}
}
